    ...
    >
      <div className="h-full w-screen flex items-center justify-center">
        <img
          ...
          className="h-[13em] w-full lg:h-[20em] lg:w-[30em] z-50"
        />
      </div>
      ...
      <div className="h-full w-screen flex items-center lg:items-start justify-center flex-col p-10 gap-5">
        <OnRevealBlack>
          <h1 className="text-justify text-5xl lg:text-6xl font-SairaBold z-50">
            Get to Know Us More
          </h1>
        </OnRevealBlack>
        <OnRevealBlack>
          <p className="text-justify max-w-[500px] text-base lg:text-xl z-50">
